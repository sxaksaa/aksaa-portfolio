    ...
    <PanelShell className="bg-[#050409]" index={0}>
      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="mx-auto w-full max-w-7xl">
          <p className="font-mono text-xs uppercase tracking-[0.34em] text-white/40">Backend Web Developer</p>
          <h1 className="mt-7 text-[clamp(7rem,23vw,20rem)] font-semibold uppercase leading-[0.72] tracking-normal text-white">Aksaa</h1>
          <p className="mt-8 max-w-xl text-2xl leading-9 text-slate-300">Backend systems, quietly composed.</p>
        </div>
      </div>
    </PanelShell>
  );
    ...
    <PanelShell className="bg-[#050409]" index={4}>
      ...
      <div className="relative z-10 mx-auto grid h-full w-full max-w-7xl items-center gap-10 lg:grid-cols-[1fr_0.8fr]">
        ...
        <div className="border-l border-white/12 pl-6">
          <p className="max-w-md text-xl leading-8 text-slate-300">A continuous cinematic portfolio for backend work, paced like moving frames.</p>
          <div className="mt-9 flex gap-7 font-mono text-[0.7rem] uppercase tracking-[0.28em] text-white/70">
            <a href="https://github.com/sxaksaa" target="_blank" rel="noreferrer" className="border-b border-white/40 pb-2">GitHub</a>
            <a href="mailto:hello@aksaa.dev" className="border-b border-white/40 pb-2">Contact</a>
          </div>
        </div>
      </div>
    </PanelShell>
